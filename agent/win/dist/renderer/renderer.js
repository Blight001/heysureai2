...
// ── Status display ─────────────────────────────────────────────────────────
function setStatus(status, _reason) {
...
function iconClass(status, type) {
    if (status === 'success')
        return 'success';
    if (status === 'error')
        return 'error';
...
function badgeClass(type) {
    const map = { task: 'task', system: 'system', error: 'error', warn: 'warn' };
