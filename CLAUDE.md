...
| 仓库            | 本地目录 | 技术栈 | 作用 | 详细文档 |
|-----------------|----------|--------|------|----------|
| HeySure-Web     | `web/`   | Vue 3 + Vite + TS | 前端控制台 | [`web/CLAUDE.md`](web/CLAUDE.md) / [`web/AGENTS.md`](web/AGENTS.md) |
| HeySure-Server  | `server/`| Python + FastAPI + Socket.IO | 后端（4 进程） | [`server/CLAUDE.md`](server/CLAUDE.md) / [`server/AGENTS.md`](server/AGENTS.md) |
