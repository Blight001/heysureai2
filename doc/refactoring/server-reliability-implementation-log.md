...
- 首轮人工同步已将根仓库更新到 `ecd36f7`、Server 子模块更新到 `eb4a453`；管理员版本端点与四 Runtime 状态均已核验。
- 发布前已生成 PostgreSQL custom-format 备份；最近一次为 `backups/heysure-pre-sync-20260810-020448.dump`（102752064 bytes）。
