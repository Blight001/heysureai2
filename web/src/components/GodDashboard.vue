...
import McpToolsModal from './god-dashboard/modals/McpToolsModal.vue'
...
import { useDashboardData } from './god-dashboard/useDashboardData'
import { useDashboardUi } from './god-dashboard/useDashboardUi'
...
const DASHBOARD_REFRESH_FAST_MS = 2000
const DASHBOARD_REFRESH_NORMAL_MS = 8000
